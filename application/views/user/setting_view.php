                            ...
                            <div class="col-sm-12 ">
                                    ...
                                    <div class=" text-center">
                                        <div class="main_home wow fadeInUp" data-wow-duration="700ms" align="center" >
                                            ...
                                            <?php echo form_open_multipart('user/edit_data'); ?>
                                                <fieldset>
                                                    <div class="form-group has-success" style="width:500px">
                                                        <!-- <input class="form-control" placeholder="Name" name="name" type="name" value="<?php echo $this->session->userdata('nama') ?>" autofocus>
                                                    </div> -->
                                                    <div class="form-group has-success" style="width:500px">
                                                        <input class="form-control" placeholder="Username" name="username" type="username"
                                                        value="<?php echo $this->session->userdata('username') ?>" autofocus>
                                                    </div>
<!--                                                     <div class="form-group has-success" style="width:500px">
                                                        <input class="form-control" placeholder="Email" name="email" type="email" autofocus>
                                                    </div> -->
                                                    <div class="form-group has-success" style="width:500px">
                                                    <label for="password"><h3>Masukkan password baru</h3></label>
                                                        <input class="form-control" placeholder="Password" name="password" type="password" value="">
                                                    </div>
                                                    <div class="form-group has-success" style="width:500px">
                                                        <!-- <center><p>Profil Pic : </p><input placeholder="Gambar" name="gambar" type="file"></center> -->
                                                    </div>
                                                    <input style="width: 300px" type="submit" value="UPDATE" class="btn btn-success btn-outline" name="">
