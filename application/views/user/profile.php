                                ...
                                <div class="main_home_slider text-center">
                                    <div class="single_home_slider">
                                        <div class="main_home wow fadeInUp" data-wow-duration="700ms">
                                            ...
                                            <div class="home_btn">
                                                <a href="<?php echo base_url('index.php/user');?>" class="btn btn-primary">LEARN MORE</a>
                                            </div>
                                    ...
                                    <div class="single_home_slider">
                                        <div class="main_home wow fadeInUp" data-wow-duration="700ms">
                                            ...
                                            <div class="home_btn">
                                                <a href="<?php echo base_url('index.php/product');?>" class="btn btn-primary">PRODUCT</a>
                                            </div>
                                    ...
                                    <div class="main_teastimonial_slider text-center">
                                        ...
                                        <div class="single_testimonial">
                                            <div class="row">
                                                <div class="col-sm-8 col-sm-offset-2">
                                                    <i class="fa fa-quote-left"></i>
                                                    <p>Seni Budaya mencerminkan Indonesia</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="single_counter border_right">
                                            <div class="col-sm-3 col-xs-12">
                                                <div class="single_counter_item">
                                                    ...
                                                    <p class="margin-top-20">Karya Anak Bangsa</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="single_counter">
                                            <div class="col-sm-3 col-xs-12">
                                                <div class="single_counter_item">
                                                    ...
                                                    <p class="margin-top-20">Karya Anak ITS</p>  
                                                </div>
                                        ...
                                        <div class="single_counter">
                                            <div class="col-sm-3 col-xs-12">
                                                <div class="single_counter_item">
                                                    ...
                                                    <p class="margin-top-20">Untuk Indonesia Lebih Baik</p> 
                                                </div>
