                                ...
                                <div class="row">
                                    ...
                                    <div class="iso-box-section wow fadeInUp" data-wow-delay="1s">
                                            <?php
                                                foreach ($produk as $p) {
                                                    ?>
                                            <div class="iso-box template col-md-4 col-sm-6" align="center">
                                                <div class="portfolio-thumb">
                                                    <img src="<?php echo base_url('assets/produk/image/'.$p['gambar_produk']);?>" class="img-responsive" alt="Portfolio" style="max-height: 300px; height: 300px">
                                                        <div class="portfolio-overlay">
                                                        <div class="portfolio-item">
                                                            <h3><?= $p['nama_produk'] ?></h3>
                                                            <h3>Rp.<?= $p['harga_produk'] ?></h3>
                                                            <a href="<?php echo base_url().'index.php/product/buyNow/'.$p['id_produk']?>" class="btn btn-success btn-outline" name="" style="font-size: 15px; padding-top: 10px">Detail</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                </div>
