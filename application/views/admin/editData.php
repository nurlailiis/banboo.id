                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Edit Produk Banboo.id
                        </div>
                        <div class="panel-body">
                        <?php echo form_open_multipart(base_url('index.php/admin/do_editData')); ?>
                                <p class="col-md-6"><input type="text" class="form-control" placeholder="Id Produk" name="id" value="<?php echo $id_produk ?>"></p>
                                <p class="col-md-6"><input type="text" class="form-control" placeholder="Product Name" name="nama" value="<?php echo $nama_produk ?>"></p>
                                <p class="col-md-6"><input type="text" class="form-control" placeholder="Price" name="harga" value="<?php echo $harga_produk ?>"></p>
                                <p class="col-md-6"><input type="text" class="form-control" placeholder="Detail" name="detail" value="<?php echo $detail_produk ?>"></p>
                                <p class="col-md-6">
                                    <img style="width: 100%" src="<?php echo base_url()."assets/produk/image/".$gambar_produk ?>">
                                    <input type="file" class="form-control" placeholder="Picture" name="gambar" value="<?php echo $gambar_produk ?>">
                                </p>
                                <p class="col-md-6"><select name="kategori" class="form-control">
                                    <option selected="" ><?php echo $kategori_produk ?></option>
